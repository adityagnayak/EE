...
LANDING_TEXT = {
    ...
    "hero_description": """Bridge the gap between chaotic spreadsheets and expensive SAP/Oracle consultants. 
...
PRODUCT_INFO = {
    "how_it_works": [
        ...
        "**Narrative:** Claude generates deep-dive commentary on cost and schedule variances.",
        "**Review:** A human-in-the-loop analyst signs off the final board-ready pack."
    ],
    "deliverables": [
